function Gn = quadG2D(examp,m,n,alpha1,beta1,alpha2,beta2)
...
[x1,lambda1] = nodesweights(m,alpha1,beta1,1);
[x2,lambda2] = nodesweights(n,alpha2,beta2,1);
[X, Y] = meshgrid(x1',x2');
f = fun2D(examp,X,Y);
Gn = lambda1'*(lambda2'*f)';
